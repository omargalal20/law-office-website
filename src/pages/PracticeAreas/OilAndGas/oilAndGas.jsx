...
const OilAndGas = () => {
  ...
  const genericOilAndGasImages = [
    ...
    },
    {
      ...
      height: '318px',
      title: 'Oil & Gas',
      textLines: ['Oil & Gas', 'Oil Price Volatility', '31 January, 2024'],
      cols: 2,
    },
  ];
  ...
  return (
    <PracticeArea
      ...
      <p
        ...
        The firm's oil & gas department at Afifi Law Office focuses on providing
        comprehensive legal services tailored to the dynamic and complex energy
        sector. Our team of experienced attorneys offers practical solutions and
        strategic guidance to clients involved in all aspects of the oil and gas
        industry. With a deep understanding of energy law, regulatory
        frameworks, and industry best practices, our team assists clients in
        navigating the unique challenges and opportunities presented by the oil
        and gas sector. From exploration and production to transportation,
        refining, and distribution, we provide legal counsel across the entire
        value chain. Our services encompass a wide range of areas, including
        contract negotiation and drafting, regulatory compliance, land use and
        leasing agreements, environmental permitting, and dispute resolution. We
        work closely with our clients to identify and mitigate legal risks while
        maximizing opportunities for growth and profitability. At Afifi Law
        Office, we recognize the importance of staying abreast of developments
        in the rapidly evolving energy landscape. Our attorneys remain at the
        forefront of industry trends and regulatory changes to ensure that our
        clients receive informed and effective legal representation.
      </p>
    </PracticeArea>
  );
};
