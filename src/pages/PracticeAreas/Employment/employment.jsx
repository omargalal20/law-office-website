...
const Employment = () => {
  ...
  const sectionHeaders = {
    firstSectionHeader: {
      ...
      sectionHeaderText:
        'Mastering Employment Dispute Resolution Pioneering Legal',
      sectionStyle: {
        width: '969px',
        fontSize: '50px',
  ...
  return (
    <PracticeArea
      ...
      <p
        ...
        Our Employment practice focuses on the essentials to assist companies in
        navigating the intricate landscape of the Employment sector. With a
        focus on ensuring compliance with Employment regulations and fostering
        sustainable Employment practices, our team at Afifi Law Office offers
        ...
        Employment law, including regulatory compliance, project development,
        transactions, and dispute resolution. Our approach prioritizes proactive
        risk management and effective resolution of Employment-related issues to
        safeguard our clients' interests and promote responsible Employment
        development. From advising on renewable Employment projects to
        negotiating Employment contracts and resolving disputes, we collaborate
        closely with clients to address their Employment law concerns
        comprehensively.
      </p>
    </PracticeArea>
  );
