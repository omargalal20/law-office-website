...
const Corporate = () => {
  ...
  const sectionHeaders = {
    firstSectionHeader: {
      ...
      sectionHeaderText:
        'Elevating Corporate Prosperity Legal Excellence for Your',
      sectionStyle: {
        width: '969px',
        fontSize: '50px',
  ...
  return (
    <PracticeArea
      ...
      <p
        ...
        The firm’s corporate practice is dedicated to supporting businesses of
        all sizes and industries. We provide tailored legal solutions to address
        diverse needs, specializing in entity formation, corporate governance,
        merger sand acquisitions, joint ventures, and regulatory compliance. Our
        experienced attorneys collaborate closely with each client to develop
        strategies aligned with their corporate goals. Whether it's establishing
        legal entities, ensuring compliance with governance standards, or
        navigating complex transactions, we offer practical advice and
        innovative solutions to achieve business objectives. From startups to
        multinational corporations, we understand the unique challenges facing
        each client and are committed to delivering exceptional legal
        representation. At Afifi Law Office, we navigate the complexities of
        corporate law with confidence and clarity, helping businesses across
        industries thrive.
      </p>
    </PracticeArea>
  );
