...
const Construction = () => {
  ...
  const sectionHeaders = {
    firstSectionHeader: {
      ...
      sectionHeaderText:
        'Building Legal Foundations Expert Law Services for the',
      sectionStyle: {
        width: '969px',
        fontSize: '50px',
  ...
  return (
    <PracticeArea
      ...
      <p
        ...
        Our construction team specializes in providing comprehensive legal
        services tailored to the intricate needs of clients involved in
        construction projects. As a cornerstone of our practice, we offer a
        wealth of experience and expertise in navigating the complexities
        inherent in construction law. Our team of seasoned attorneys possesses a
        deep understanding of the multifaceted legal landscape surrounding
        construction endeavors. From contract negotiation and drafting to
        dispute resolution and litigation, we adeptly guide our clients through
        every stage of the construction process. At Afifi Law Office, we
        recognize the importance of fostering strong client relationships built
        on trust, communication, and collaboration. We work closely with
        contractors, subcontractors, developers, architects, engineers, and
        other stakeholders to ensure that their interests are safeguarded, and
        their objectives are achieved. Whether addressing issues related to
        project delays, defective workmanship, payment disputes, or regulatory
        compliance, our construction department is committed to providing
        strategic legal counsel tailored to each client's unique circumstances.
      </p>
    </PracticeArea>
  );
};
