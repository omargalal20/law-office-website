...
const Competition = () => {
  ...
  const sectionHeaders = {
    firstSectionHeader: {
      ...
      sectionHeaderText:
        'Mastering Competition Dispute Resolution Pioneering Legal',
      sectionStyle: {
        width: '969px',
        fontSize: '50px',
  ...
  return (
    <PracticeArea
      ...
      <p
        ...
        Our Competition practice focuses on the essentials to assist companies
        in navigating the intricate landscape of the Competition sector. With a
        focus on ensuring compliance with Competition regulations and fostering
        sustainable Competition practices, our team at Afifi Law Office offers
        ...
        Competition law, including regulatory compliance, project development,
        transactions, and dispute resolution. Our approach prioritizes proactive
        risk management and effective resolution of Competition-related issues
        to safeguard our clients' interests and promote responsible Competition
        development. From advising on renewable Competition projects to
        negotiating Competition contracts and resolving disputes, we collaborate
        closely with clients to address their Competition law concerns
        comprehensively.
      </p>
    </PracticeArea>
  );
