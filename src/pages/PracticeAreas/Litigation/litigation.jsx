...
const Litigation = () => {
  ...
  const sectionHeaders = {
    firstSectionHeader: {
      ...
      sectionHeaderText:
        'Mastering Litigation Dispute Resolution Pioneering Legal',
      sectionStyle: {
        width: '969px',
        fontSize: '50px',
  ...
  return (
    <PracticeArea
      ...
      <p
        ...
        Our Litigation practice focuses on the essentials to assist companies in
        navigating the intricate landscape of the Litigation sector. With a
        focus on ensuring compliance with Litigation regulations and fostering
        sustainable Litigation practices, our team at Afifi Law Office offers
        ...
        Litigation law, including regulatory compliance, project development,
        transactions, and dispute resolution. Our approach prioritizes proactive
        risk management and effective resolution of Litigation-related issues to
        safeguard our clients' interests and promote responsible Litigation
        development. From advising on renewable Litigation projects to
        negotiating Litigation contracts and resolving disputes, we collaborate
        closely with clients to address their Litigation law concerns
        comprehensively.
      </p>
    </PracticeArea>
  );
