                ...
                <Container maxWidth="lg" style={{ marginTop: "10vh", marginBottom: "10vh" }}>
                    ...
                    <Stack direction={"row"} spacing={1} sx={{ marginBottom: "10vh" }}>
                        ...
                        <Box sx={{ width: '50%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
                            <Typography variant="h6" sx={{ fontFamily: 'Montserrat', fontSize: 50, fontWeight: 300, lineHeight: '61px', letterSpacing: '0em', textAlign: 'left', marginBottom: "1vh" }}>
                                Old Interns
                            </Typography>
                            ...
                            <Typography variant="body1" sx={{ fontFamily: 'Montserrat', fontSize: 18, fontWeight: 400, lineHeight: '22px', letterSpacing: '0em', textAlign: 'left' }}>
                                Our internship program is specifically designed to bridge the gap between academic learning and real-world legal practice. Our interns play a pivotal role in guiding fresh graduates, offering insights, hands-on experience, and mentorship.
                                <br /><br />
                                This supportive network not only enhances practical skills but also helps new graduates align their career aspirations with achievable goals, setting a strong foundation for a successful legal career.
                            </Typography>
                        </Box>
                    </Stack>
                    ...
                    <Stack direction={"row"} spacing={1} sx={{ marginBottom: "10vh" }}>
                        <Box sx={{ width: '50%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end' }}>
                            ...
                            <Typography variant="body1" sx={{ fontFamily: 'Montserrat', fontSize: 18, fontWeight: 400, lineHeight: '22px', letterSpacing: '0em', textAlign: 'left' }}>
                                Our internship program is to create a nurturing and dynamic environment where interns are key catalysts in shaping the future of fresh law graduates. We strive to foster a culture of mentorship, collaboration, and practical skill-building, ensuring that each intern is not just an observer but an active participant in legal processes.
                                <br /><br />
                                This approach aims to equip new graduates with the confidence, knowledge, and experience necessary to excel in the legal profession, ultimately shaping the next generation of legal experts.
                            </Typography>
                        </Box>
                ...
                <Container maxWidth="lg" style={{ marginTop: "10vh", marginBottom: "10vh" }}>
                    <Stack direction={"column"} spacing={3}>
                        {formInputs.map((input, index) => (
                            <CustomInput key={index} inputType={input.inputType} inputTitle={input.inputTitle} />
                        ))}
                    </Stack>
