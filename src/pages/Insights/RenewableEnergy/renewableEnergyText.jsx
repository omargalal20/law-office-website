...
const RenewableEnergyText = () => {
    return (
        <div style={{
            ...
            <h2 style={{ marginBottom: "20px" }}>A Legacy of Ambition:</h2>

            <p style={{ marginBottom: "20px" }}>
                Both Egypt and the UAE have positioned themselves as regional leaders in the realm of clean energy advancements. Egypt sets ambitious renewable energy targets, aiming for a 42% share in its electricity mix by 2035. Notably, it has attracted substantial investments for projects like the Benban Solar Park, the world's largest photovoltaic power plant, highlighting its dedication to solar energy.
            </p>
            <p style={{ marginBottom: "20px" }}>
                Meanwhile, the UAE champions innovation with initiatives like Masdar City, a sustainable metropolis powered by renewable energy. The nation has committed to achieving net-zero emissions by 2050, heavily investing in research and development of clean technologies such as hydrogen and carbon capture.
            </p>

            <h2 style={{ marginBottom: "20px" }}>Charting the Course at COP27 and COP28:</h2>
            ...
            <h2 style={{ marginBottom: "20px" }}>Real-Life Data and Global Implications:</h2>

            <p style={{ marginBottom: "20px" }}>
                The outcomes of COP27 and COP28 hold immense significance, extending beyond the borders of Egypt and the UAE.
            </p>
            <p style={{ marginBottom: "20px" }}>
