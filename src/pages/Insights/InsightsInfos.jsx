...
import CapitalRetentionText from './InsightsTexts/CapitalRetention/CapitalRetentionText';
...
export const InsightsInfo = {
  ...
  constructionTrends: {
    heroDetails: {
      ...
      heroSecondaryHeading: 'Insights',
      heroSubHeading:
        "Construction Trends in Egypt Charting the Future of Concrete and Steel Emerging Trends and Untapped Potential in Egypt's Construction Landscape by 2025",
    },
    relatedInsights: [
      {
  ...
  crcicaRules: {
    heroDetails: {
      ...
      heroSecondaryHeading: 'Insights',
      heroSubHeading:
        'A New Dawn for International Arbitration Unveiling the CRCICA Rules 2024',
    },
    relatedInsights: [
      {
  ...
  energyGlobalDemand: {
    heroDetails: {
      ...
      heroSecondaryHeading: 'Insights',
      heroSubHeading:
        "Energy Global Demand Navigating the Energy Sea Egypt's Strategic Optimization for a Dynamic Global Market",
    },
    relatedInsights: [
      {
  ...
  gafi: {
    heroDetails: {
      ...
      heroSecondaryHeading: 'Insights',
      heroSubHeading:
        'GAFI Streamlines Post-Incorporation Services with Lenient Document Requirements',
    },
    relatedInsights: [
      {
        img: insightsAiImage,
  ...
  internationalFinance: {
    heroDetails: {
      ...
      heroSecondaryHeading: 'Insights',
      heroSubHeading:
        "International Finance A Catalyst for Prosperity International Finance Corporation Injects USD 7 Billion into Egypt's Economic Engine",
    },
    relatedInsights: [
      {
        img: mainInsightsLawLaborImage,
  ...
  laborLaw: {
    heroDetails: {
      ...
      heroSecondaryHeading: 'Insights',
      heroSubHeading:
        "New A Balancing Act: Egypt's New Labor Law Navigates a Complex Landscape",
    },
    relatedInsights: [
      {
  ...
  transportationLogistics: {
    heroDetails: {
      ...
      heroSecondaryHeading: 'Insights',
      heroSubHeading:
        "Transportation & Logistics Hub Ascending the Logistics Ladder Egypt's Strategic Transformation into a Global Transport and Logistics Hub by 2024",
    },
    relatedInsights: [
      {
