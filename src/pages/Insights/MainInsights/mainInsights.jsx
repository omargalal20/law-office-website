...
const MainInsights = () => {
  const [viewMoreInsights, setViewMoreInsights] = useState(MainInsightsConstants.COLLAPSED);
        ...
        <Container maxWidth="lg" style={{ marginTop: "56px" }}>
          ...
          <Stack direction={"row"} spacing={4} sx={{ marginBottom: "20px" }}>
            <HoverableImage
              ...
              width={"100%"}
              height={"692px"}
              text={["Technology", "Legal Tech Revolution", "", "31 January, 2024"]}
            />
            ...
            <Stack spacing={4}>
              ...
              <HoverableImage
                ...
                width={"100%"}
                height={"318px"}
                text={["Renewable Energy", "Sustainable Development Trends", "", "31 January, 2024"]}
              />
            </Stack>
          </Stack>
          ...
          <Stack direction={"row"} spacing={4} sx={{ marginBottom: "20px" }}>
            <Stack spacing={4}>
              ...
              <ViewMoreInsights state={viewMoreInsights} toggleView={toggleView} setExpanded={setExpanded} />
            </Stack>
          ...
          {expanded && (
            <Stack direction={"row"} spacing={4} sx={{ marginBottom: "20px" }}>
              <Stack spacing={4}>
                ...
                <ViewMoreInsights state={MainInsightsConstants.EXPANDED} toggleView={toggleView} setExpanded={setExpanded} />
              </Stack>
